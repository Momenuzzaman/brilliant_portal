...
const UserManagement = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${rootUrl}rest/auth/addUser`, userData)
      .then((response) => {
        handleClose();
        fetchUsers();
      })
  ...
  const handleUpdateSubmit = (e, id) => {
    ...
    axios
      .put(`${rootUrl}rest/auth/editUser/${id}`, updateUserData, {
        headers: {
          Authorization: userInfo.token,
        },
      })
  ...
  const handleDeleteUser = (id) => {
    axios
      .delete(`${rootUrl}rest/auth/removeUser/${id}`)
      .then((response) => {
        fetchUsers();
      })
      .catch((error) => {
